        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Empowering learners worldwide with high-quality online courses and professional development programs.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to get updates on new courses and special offers.</p>
